...
runSSHCmd $SSH_CONFIG_FILE swarm-master "docker -H=0.0.0.0:2375 pull swarm"
...
do
	...
	runSSHCmd $SSH_CONFIG_FILE $VM_NAME \
...
runSSHCmd $SSH_CONFIG_FILE swarm-master "docker -H=0.0.0.0:2375 run -d -p 2377:2375 swarm manage token://$SWARM_CLUSTER_ID"
